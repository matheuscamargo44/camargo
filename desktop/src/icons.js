...
const SVG_ICONS = {
  ...
  "user-plus":    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>`,
  dices:          `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="12" height="12" x="2" y="10" rx="2" ry="2"/><path d="m17.92 14 3.5-3.5a2.41 2.41 0 0 0 0-3.41l-4.5-4.5a2.41 2.41 0 0 0-3.41 0L10 6.09"/><circle cx="6" cy="14" r="0.5" fill="currentColor"/><circle cx="10" cy="18" r="0.5" fill="currentColor"/></svg>`,
...
const FEATURE_ICON_MAP = {
  ...
  auto_play_again: "repeat",
  auto_honor: "heart",
  auto_party_invite: "user-plus",
  aram_bench_swap: "shuffle",
  aram_augment_advisor: "sparkles",
  random_skin: "dices",
  instalock: "crosshair",
  autoban: "shield",
  ...
  presence_status: "smartphone",
  ranked_presence: "shield",
  friend_requests: "inbox",
